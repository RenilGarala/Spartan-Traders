          ...
          <div className="w-full lg:w-2/5">
            <div className="mb-8">
              ...
              <div className="flex items-center space-x-3 group cursor-pointer mb-6">
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
            ...
            <div className="backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-blue-500/30 transition-all duration-300">
              <p className="text-gray-300 leading-relaxed text-base">
                Trusted supplier of scrap steel, industrial pipes, and valve casting products across Canada. 
                We provide high-quality, cost-effective, and reliable industrial solutions that power progress.
              </p>
        ...
        <div className="relative mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-sm">
              {['Privacy Policy', 'Terms of Service', 'Site Map'].map((link: string) => (
                <a 
                  key={link}
                  href="#" 
