...
export default function Home() {
  ...
  const products = [
    {
      title: "Scrap Steel",
      description: "Professional scrap steel buying and selling services with competitive pricing and reliable pickup.",
      features: ["HMS & Structural Steel", "Fair Market Pricing", "Pickup Services"],
      gradient: "from-slate-900 via-slate-700 to-slate-500"
    },
    {
      title: "Pipe Products", 
      description: "Comprehensive range of carbon steel pipes including OCTG, line pipe, and seamless products.",
    ...
    },
    {
      ...
      description: "High-quality valve components and castings for industrial applications with custom manufacturing.",
  ...
  const benefits = [
    {
      ...
      description: "Our products meet strict quality standards to ensure long-term performance in industrial applications.",
      icon: "🔧"
    },
    {
      title: "Reliable Delivery",
      description: "On-time, every time - we take deadlines seriously so your projects stay on track.",
      icon: "🚚"
    },
    {
      title: "Industry Expertise", 
      description: "With years of experience, we provide solutions tailored to your specific industrial needs.",
      icon: "⚡"
    }
  ];
  ...
  return (
    <div className="font-sans text-white bg-black overflow-hidden">
      ...
      >
        ...
        <div className={`relative z-10 max-w-6xl text-center px-6 transition-all duration-2000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
          <div className="mb-8">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-lg md:text-xl text-blue-200/80 max-w-4xl mx-auto leading-relaxed">
              Leading Canadian distributor of scrap steel, carbon steel pipes, and valve casting products. 
              Quality materials for industrial applications that build the future.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <button className="group px-8 py-4 border-2 border-blue-400/50 rounded-full font-semibold text-lg backdrop-blur-sm bg-white/5 hover:bg-white/10 hover:border-blue-300 transition-all duration-300 hover:scale-105">
              <span className="flex items-center gap-3">
                CONTACT US
                <svg className="w-5 h-5 group-hover:rotate-45 transition-transform" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Spartan Traders is your trusted Canadian partner for premium steel solutions. 
              We serve industrial clients with unmatched quality and exceptional service.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We're not just another industrial supplier — we're your trusted partner 
              committed to delivering excellence, reliability, and innovation.
            </p>
          </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-blue-950 via-blue-900 to-blue-950 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 leading-relaxed">
            Partner with Spartan Traders today and experience the difference that quality, 
            expertise, and reliability can make for your industrial projects.
          </p>
